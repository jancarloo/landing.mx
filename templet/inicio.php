            ...
            <div class="row">
                <div class="col-md-4 detailed-icon-wrap">
                    ...
                    <div class="detailed-block reveal fadeInLeft" data-wow-delay="0.6s"> <span class="pe-primary pe-7s-photo"></span>
                        <div class="detailed-title">
                            <h4 class="jmy_web_div" data-page="inicio" id="landing2_titulo3.">
                            <?php $this->pnt('landing2_titulo3','React native support'); ?></h4>

                            <p class="text-muted jmy_web_div" data-page="inicio" id="landing2_texto3">
                            <?php $this->pnt('landing2_texto3','Holisticly cultivate effective web services for leading-edge users. Completely myocardinate impactful '); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 detailed-icon-wrap">
                    <div class="detailed-block2 reveal fadeInRight"> <span class="pe-primary pe-7s-rocket detailed-icon2"></span>
                            ...
                            <?php $this->pnt('landing2_titulo4','React native support'); ?></h4>
